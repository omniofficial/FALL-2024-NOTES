...
// Due date: 10/30/24
// Purpose: Write a program to determine which of the following expressions are accepted/rejected by the given grammar and parsing table: (i+i)*i$, i*(i-i)$, i(i+i)$. Show the content of the stack after each match.
// -------------------------------
